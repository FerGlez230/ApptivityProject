if (function(e, t) {
    ...
    function u() {
        te.removeEventListener("DOMContentLoaded", u), e.removeEventListener("load", u), 
        pe.ready();
    }
    function f() {
    ...
    function h(e, t, n, i) {
        var o, r = 1, s = 20, a = i ? function() {
            ...
            return pe.css(e, t, "");
        }, c = a(), l = n && n[3] || (pe.cssNumber[t] ? "" : "px"), u = (pe.cssNumber[t] || "px" !== l && +c) && Ie.exec(pe.css(e, t));
        if (u && u[3] !== l) {
            l = l || u[3], n = n || [], u = +c || 1;
            do {
                u /= r = r || ".5", pe.style(e, t, u + l);
            } while (r !== (r = a() / c) && 1 !== r && --s);
        }
        return n && (u = +u || +c || 0, o = n[1] ? u + (n[1] + 1) * n[2] : +n[2], i && (i.unit = l, 
        i.start = u, i.end = o)), o;
    }
    function m(e) {
    ...
    function v(e, t) {
        ...
        t ? ("none" === n && (o[r] = Oe.get(i, "display") || null, o[r] || (i.style.display = "")), 
        "" === i.style.display && He(i) && (o[r] = m(i))) : "none" !== n && (o[r] = "none", 
        Oe.set(i, "display", n)));
    ...
    function b(e, t, n, i, o) {
        for (var r, s, a, c, l, u, f = t.createDocumentFragment(), d = [], p = 0, h = e.length; p < h; p++) if ((r = e[p]) || 0 === r) if ("object" === pe.type(r)) pe.merge(d, r.nodeType ? [ r ] : r); else if (Ye.test(r)) {
            for (s = s || f.appendChild(t.createElement("div")), a = (ze.exec(r) || [ "", "" ])[1].toLowerCase(), 
            c = Xe[a] || Xe._default, s.innerHTML = c[1] + pe.htmlPrefilter(r) + c[2], u = c[0]; u--; ) s = s.lastChild;
            pe.merge(d, s.childNodes), (s = f.firstChild).textContent = "";
        } else d.push(t.createTextNode(r));
        for (f.textContent = "", p = 0; r = d[p++]; ) if (i && pe.inArray(r, i) > -1) o && o.push(r); else if (l = pe.contains(r.ownerDocument, r), 
        s = g(f.appendChild(r), "script"), l && y(s), n) for (u = 0; r = s[u++]; ) Ve.test(r.type || "") && n.push(r);
        return f;
    }
    function x() {
        return !0;
    ...
    function D(e, t) {
        var n, i, o, r, s, a, c, l;
        if (1 === t.nodeType) {
            if (Oe.hasData(e) && (r = Oe.access(e), s = Oe.set(t, r), l = r.events)) {
                delete s.handle, s.events = {};
                for (o in l) for (n = 0, i = l[o].length; n < i; n++) pe.event.add(t, o, l[o][n]);
            }
            Le.hasData(e) && (a = Le.access(e), c = pe.extend({}, a), Le.set(t, c));
        }
    }
    function S(e, t) {
    ...
    function k(e, t, i, o) {
        t = oe.apply([], t);
        var r, s, a, c, l, u, f = 0, d = e.length, p = d - 1, h = t[0], m = pe.isFunction(h);
        if (m || d > 1 && "string" == typeof h && !de.checkClone && et.test(h)) return e.each(function(n) {
            var r = e.eq(n);
            m && (t[0] = h.call(this, n, r.html())), k(r, t, i, o);
        });
        if (d && (r = b(t, e[0].ownerDocument, !1, e, o), s = r.firstChild, 1 === r.childNodes.length && (r = s), 
        s || o)) {
            for (c = (a = pe.map(g(r, "script"), $)).length; f < d; f++) l = r, f !== p && (l = pe.clone(l, !0, !0), 
            c && pe.merge(a, g(l, "script"))), i.call(e[f], l, f);
            if (c) for (u = a[a.length - 1].ownerDocument, pe.map(a, E), f = 0; f < c; f++) l = a[f], 
            Ve.test(l.type || "") && !Oe.access(l, "globalEval") && pe.contains(u, l) && (l.src ? pe._evalUrl && pe._evalUrl(l.src) : n(l.textContent.replace(nt, ""), u));
        }
        return e;
    }
    function A(e, t, n) {
        for (var i, o = t ? pe.filter(t, e) : e, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || pe.cleanData(g(i)), 
        i.parentNode && (n && pe.contains(i.ownerDocument, i) && y(g(i, "script")), i.parentNode.removeChild(i));
        return e;
    }
    function N(e, t, n) {
    ...
    function B(e, t, n, i, o) {
        var r, s = 0;
        for (r = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0; r < 4; r += 2) "margin" === n && (s += pe.css(e, n + Re[r], !0, o)), 
        i ? ("content" === n && (s -= pe.css(e, "padding" + Re[r], !0, o)), "margin" !== n && (s -= pe.css(e, "border" + Re[r] + "Width", !0, o))) : (s += pe.css(e, "padding" + Re[r], !0, o), 
    ...
    function _(e, t, n) {
        ...
        return i + B(e, t, n || (s ? "border" : "content"), o, r) + "px";
    }
    function q(e, t, n, i, o) {
        return new q.prototype.init(e, t, n, i, o);
    }
    function I() {
        dt && (e.requestAnimationFrame(I), pe.fx.tick());
    }
    function R() {
    ...
    function W(e, t, n) {
        var i, o, r, s, a, c, l, u, f = "width" in t || "height" in t, d = this, p = {}, h = e.style, m = e.nodeType && He(e), g = Oe.get(e, "fxshow");
        ...
        if ((c = !pe.isEmptyObject(t)) || !pe.isEmptyObject(p)) {
            ...
            null == (l = g && g.display) && (l = Oe.get(e, "display")), "none" === (u = pe.css(e, "display")) && (l ? u = l : (v([ e ], !0), 
            l = e.style.display || l, u = pe.css(e, "display"), v([ e ]))), ("inline" === u || "inline-block" === u && null != l) && "none" === pe.css(e, "float") && (c || (d.done(function() {
                h.display = l;
            }), null == l && (u = h.display, l = "none" === u ? "" : u)), h.display = "inline-block")), 
            n.overflow && (h.overflow = "hidden", d.always(function() {
                h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2];
            })), c = !1;
            for (i in p) c || (g ? "hidden" in g && (m = g.hidden) : g = Oe.access(e, "fxshow", {
                display: l
            }), r && (g.hidden = !m), m && v([ e ], !0), d.done(function() {
                m || v([ e ]), Oe.remove(e, "fxshow");
                for (i in p) pe.style(e, i, p[i]);
            })), c = F(m ? g[i] : 0, i, d), i in g || (g[i] = c.start, m && (c.end = c.start, 
            c.start = 0));
        }
    }
    function M(e, t) {
    ...
    function z(e, t, n) {
        var i, o, r = 0, s = z.prefilters.length, a = pe.Deferred().always(function() {
            delete c.elem;
        }), c = function() {
            if (o) return !1;
            for (var t = ft || R(), n = Math.max(0, l.startTime + l.duration - t), i = 1 - (n / l.duration || 0), r = 0, s = l.tweens.length; r < s; r++) l.tweens[r].run(i);
            return a.notifyWith(e, [ l, i, n ]), i < 1 && s ? n : (a.resolveWith(e, [ l ]), 
            !1);
        }, l = a.promise({
            elem: e,
            props: pe.extend({}, t),
        ...
        for (M(u, l.opts.specialEasing); r < s; r++) if (i = z.prefilters[r].call(l, e, u, l.opts)) return pe.isFunction(i.stop) && (pe._queueHooks(l.elem, l.opts.queue).stop = pe.proxy(i.stop, i)), 
        i;
        return pe.map(u, F, l), pe.isFunction(l.opts.start) && l.opts.start.call(e, l), 
    ...
    function Y(e, t, n, i) {
        ...
        }); else if (n || "object" !== pe.type(t)) i(e, t); else for (o in t) Y(e + "[" + o + "]", t[o], n, i);
    }
    function U(e) {
        return function(t, n) {
    ...
    function K(e, t, n, i) {
        function o(a) {
            ...
            return r[a] = !0, pe.each(e[a] || [], function(e, a) {
                var l = a(t, n, i);
                return "string" != typeof l || s || r[l] ? s ? !(c = l) : void 0 : (t.dataTypes.unshift(l), 
                o(l), !1);
            }), c;
        }
        var r = {}, s = e === _t;
    ...
    function Q(e, t, n, i) {
        ...
        !c && i && e.dataFilter && (t = e.dataFilter(t, e.dataType)), c = r, r = u.shift()) if ("*" === r) r = c; else if ("*" !== c && c !== r) {
    ...
    var ee = [], te = e.document, ne = Object.getPrototypeOf, ie = ee.slice, oe = ee.concat, re = ee.push, se = ee.indexOf, ae = {}, ce = ae.toString, le = ae.hasOwnProperty, ue = le.toString, fe = ue.call(Object), de = {}, pe = function(e, t) {
        return new pe.fn.init(e, t);
    }, he = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, me = /^-ms-/, ve = /-([a-z])/g, ge = function(e, t) {
    ...
    pe.fn = pe.prototype = {
        ...
        for ("boolean" == typeof s && (l = s, s = arguments[a] || {}, a++), "object" == typeof s || pe.isFunction(s) || (s = {}), 
        a === c && (s = this, a--); a < c; a++) if (null != (e = arguments[a])) for (t in e) n = s[t], 
        s !== (i = e[t]) && (l && i && (pe.isPlainObject(i) || (o = pe.isArray(i))) ? (o ? (o = !1, 
        r = n && pe.isArray(n) ? n : []) : r = n && pe.isPlainObject(n) ? n : {}, s[t] = pe.extend(l, r, i)) : void 0 !== i && (s[t] = i));
        return s;
    }, pe.extend({
        ...
        isPlainObject: function(e) {
            var t, n;
            return !(!e || "[object Object]" !== ce.call(e)) && (!(t = ne(e)) || "function" == typeof (n = le.call(t, "constructor") && t.constructor) && ue.call(n) === fe);
        },
    ...
    var ye = function(e) {
        function t(e, t, n, i) {
            var o, r, s, a, c, u, d, p = t && t.ownerDocument, h = t ? t.nodeType : 9;
            if (n = n || [], "string" != typeof e || !e || 1 !== h && 9 !== h && 11 !== h) return n;
            if (!i && ((t ? t.ownerDocument || t : R) !== N && A(t), t = t || N, O)) {
                if (11 !== h && (c = me.exec(e))) if (o = c[1]) {
                    if (9 === h) {
                        if (!(s = t.getElementById(o))) return n;
                        if (s.id === o) return n.push(s), n;
                    } else if (p && (s = p.getElementById(o)) && q(t, s) && s.id === o) return n.push(s), 
                    n;
                } else {
                    if (c[2]) return G.apply(n, t.getElementsByTagName(e)), n;
                    if ((o = c[3]) && x.getElementsByClassName && t.getElementsByClassName) return G.apply(n, t.getElementsByClassName(o)), 
                    n;
                }
                if (x.qsa && !z[e + " "] && (!L || !L.test(e))) {
                    if (1 !== h) p = t, d = e; else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(be, xe) : t.setAttribute("id", a = I), 
                        r = (u = T(e)).length; r--; ) u[r] = "#" + a + " " + f(u[r]);
                        d = u.join(","), p = ve.test(e) && l(t.parentNode) || t;
                    }
                    if (d) try {
        ...
        function d(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                } else for (;t = t[i]; ) if (1 === t.nodeType || s) if (f = t[I] || (t[I] = {}), 
                u = f[t.uniqueID] || (f[t.uniqueID] = {}), o && o === t.nodeName.toLowerCase()) t = t[i] || t; else {
                    if ((l = u[r]) && l[0] === H && l[1] === a) return d[2] = l[2];
        ...
        function m(e, t, n, i, o) {
            for (var r, s = [], a = 0, c = e.length, l = null != t; a < c; a++) (r = e[a]) && (n && !n(r, i, o) || (s.push(r), 
            l && t.push(a)));
            return s;
        }
        function v(e, t, n, o, r, s) {
            return o && !o[I] && (o = v(o)), r && !r[I] && (r = v(r, s)), i(function(i, s, a, c) {
                var l, u, f, d = [], p = [], v = s.length, g = i || h(t || "*", a.nodeType ? [ a ] : a, []), y = !e || !i && t ? g : m(g, d, e, a, c), b = n ? r || (i ? e : v || o) ? [] : s : y;
                if (n && n(y, b, a, c), o) for (l = m(b, p), o(l, [], a, c), u = l.length; u--; ) (f = l[u]) && (b[p[u]] = !(y[p[u]] = f));
                if (i) {
                    if (r || e) {
                        if (r) {
                        ...
                        for (u = b.length; u--; ) (f = b[u]) && (l = r ? Q(i, f) : d[u]) > -1 && (i[l] = !(s[l] = f));
                    }
                } else b = m(b === s ? b.splice(v, b.length) : b), r ? r(null, s, b, c) : G.apply(s, b);
            });
        }
        function g(e) {
            for (var t, n, i, o = e.length, r = C.relative[e[0].type], s = r || C.relative[" "], a = r ? 1 : 0, c = d(function(e) {
                ...
                var o = !r && (i || n !== D) || ((t = n).nodeType ? c(e, n, i) : l(e, n, i));
                return t = null, o;
            } ]; a < o; a++) if (n = C.relative[e[a].type]) u = [ d(p(u), n) ]; else {
                if ((n = C.filter[e[a].type].apply(null, e[a].matches))[I]) {
                    ...
                    return v(a > 1 && p(u), a > 1 && f(e.slice(0, a - 1).concat({
                        value: " " === e[a - 2].type ? "*" : ""
                    })).replace(re, "$1"), n, a < i && g(e.slice(a, i)), i < o && g(e = e.slice(i)), i < o && f(e));
                }
                u.push(n);
            }
            return p(u);
        ...
        function y(e, n) {
            var o = n.length > 0, r = e.length > 0, s = function(i, s, a, c, l) {
                var u, f, d, p = 0, h = "0", v = i && [], g = [], y = D, b = i || r && C.find.TAG("*", l), x = H += null == y ? 1 : Math.random() || .1, w = b.length;
                for (l && (D = s === N || s || l); h !== w && null != (u = b[h]); h++) {
                    if (r && u) {
                        for (f = 0, s || u.ownerDocument === N || (A(u), a = !O); d = e[f++]; ) if (d(u, s || N, a)) {
                            c.push(u);
                            break;
                        }
                        l && (H = x);
                ...
                if (p += h, o && h !== p) {
                    ...
                    if (i) {
                        if (p > 0) for (;h--; ) v[h] || g[h] || (g[h] = U.call(c));
                        g = m(g);
                    }
        ...
        var b, x, C, w, j, T, $, E, D, S, k, A, N, P, O, L, B, _, q, I = "sizzle" + 1 * new Date(), R = e.document, H = 0, F = 0, W = n(), M = n(), z = n(), V = function(e, t) {
            return e === t && (k = !0), 0;
        }, X = {}.hasOwnProperty, Y = [], U = Y.pop, K = Y.push, G = Y.push, J = Y.slice, Q = function(e, t) {
            for (var n = 0, i = e.length; n < i; n++) if (e[n] === t) return n;
            return -1;
        }, Z = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ee = "[\\x20\\t\\r\\n\\f]", te = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", ne = "\\[" + ee + "*(" + te + ")(?:" + ee + "*([*^$|!~]?=)" + ee + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + te + "))|)" + ee + "*\\]", ie = ":(" + te + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ne + ")*)|.*)\\)|)", oe = new RegExp(ee + "+", "g"), re = new RegExp("^" + ee + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ee + "+$", "g"), se = new RegExp("^" + ee + "*," + ee + "*"), ae = new RegExp("^" + ee + "*([>+~]|" + ee + ")" + ee + "*"), ce = new RegExp("=" + ee + "*([^\\]'\"]*?)" + ee + "*\\]", "g"), le = new RegExp(ie), ue = new RegExp("^" + te + "$"), fe = {
            ID: new RegExp("^#(" + te + ")"),
            CLASS: new RegExp("^\\.(" + te + ")"),
            TAG: new RegExp("^(" + te + "|[*])"),
            ATTR: new RegExp("^" + ne),
        ...
        }, de = /^(?:input|select|textarea|button)$/i, pe = /^h\d$/i, he = /^[^{]+\{\s*\[native \w/, me = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ve = /[+~]/, ge = new RegExp("\\\\([\\da-f]{1,6}" + ee + "?|(" + ee + ")|.)", "ig"), ye = function(e, t, n) {
            var i = "0x" + t - 65536;
        ...
        x = t.support = {}, j = t.isXML = function(e) {
            ...
            return i !== N && 9 === i.nodeType && i.documentElement ? (N = i, P = N.documentElement, 
            O = !j(N), R !== N && (n = N.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), 
            ...
            }, B = [], L = [], (x.qsa = he.test(N.querySelectorAll)) && (o(function(e) {
            ...
            })), (x.matchesSelector = he.test(_ = P.matches || P.webkitMatchesSelector || P.mozMatchesSelector || P.oMatchesSelector || P.msMatchesSelector)) && o(function(e) {
                x.disconnectedMatch = _.call(e, "*"), _.call(e, "[s!='']:x"), B.push("!=", ie);
            }), L = L.length && new RegExp(L.join("|")), B = B.length && new RegExp(B.join("|")), 
            t = he.test(P.compareDocumentPosition), q = t || he.test(P.contains) ? function(e, t) {
                ...
                1 & n || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === N || e.ownerDocument === R && q(R, e) ? -1 : t === N || t.ownerDocument === R && q(R, t) ? 1 : S ? Q(S, e) - Q(S, t) : 0 : 4 & n ? -1 : 1);
            } : function(e, t) {
                if (e === t) return k = !0, 0;
                var n, i = 0, o = e.parentNode, r = t.parentNode, a = [ e ], c = [ t ];
                if (!o || !r) return e === N ? -1 : t === N ? 1 : o ? -1 : r ? 1 : S ? Q(S, e) - Q(S, t) : 0;
                if (o === r) return s(e, t);
            ...
            if ((e.ownerDocument || e) !== N && A(e), n = n.replace(ce, "='$1']"), x.matchesSelector && O && !z[n + " "] && (!B || !B.test(n)) && (!L || !L.test(n))) try {
                var i = _.call(e, n);
                if (i || x.disconnectedMatch || e.document && 11 !== e.document.nodeType) return i;
            } catch (e) {}
            return t(n, N, null, [ e ]).length > 0;
        }, t.contains = function(e, t) {
            return (e.ownerDocument || e) !== N && A(e), q(e, t);
        }, t.attr = function(e, t) {
            (e.ownerDocument || e) !== N && A(e);
            var n = C.attrHandle[t.toLowerCase()], i = n && X.call(C.attrHandle, t.toLowerCase()) ? n(e, t, !O) : void 0;
            ...
            var t, n = [], i = 0, o = 0;
            if (k = !x.detectDuplicates, S = !x.sortStable && e.slice(0), e.sort(V), k) {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return fe.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && le.test(n) && (t = T(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), 
            ...
            filter: {
                ...
                CHILD: function(e, t, n, i, o) {
                    ...
                    return 1 === i && 0 === o ? function(e) {
                        ...
                        var l, u, f, d, p, h, m = r !== s ? "nextSibling" : "previousSibling", v = t.parentNode, g = a && t.nodeName.toLowerCase(), y = !c && !a, b = !1;
                        if (v) {
                            if (r) {
                                for (;m; ) {
                            ...
                            if (h = [ s ? v.firstChild : v.lastChild ], s && y) {
                                for (b = (p = (l = (u = (f = (d = v)[I] || (d[I] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === H && l[1]) && l[2], 
                                d = p && v.childNodes[p]; d = ++p && d && d[m] || (b = p = 0) || h.pop(); ) if (1 === d.nodeType && ++b && d === t) {
                                    u[e] = [ H, p, b ];
                                    break;
                                }
                            } else if (y && (b = p = (l = (u = (f = (d = t)[I] || (d[I] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === H && l[1]), 
                            !1 === b) for (;(d = ++p && d && d[m] || (b = p = 0) || h.pop()) && ((a ? d.nodeName.toLowerCase() !== g : 1 !== d.nodeType) || !++b || (y && ((u = (f = d[I] || (d[I] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [ H, b ]), 
                            d !== t)); ) ;
                ...
                PSEUDO: function(e, n) {
                    ...
                    return r[I] ? r(n) : r.length > 1 ? (o = [ e, e, "", n ], C.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function(e, t) {
                        for (var i, o = r(e, n), s = o.length; s--; ) e[i = Q(e, o[s])] = !(t[i] = o[s]);
                    }) : function(e) {
                        return r(e, 0, o);
                    }) : r;
                }
        ...
        return u.prototype = C.filters = C.pseudos, C.setFilters = new u(), T = t.tokenize = function(e, n) {
            ...
            for (a = e, c = [], l = C.preFilter; a; ) {
                ...
                for (s in C.filter) !(o = fe[s].exec(a)) || l[s] && !(o = l[s](o)) || (i = o.shift(), 
                r.push({
                    value: i,
                    type: s,
                    matches: o
            ...
            return n ? a.length : a ? t.error(e) : M(e, c).slice(0);
        }, $ = t.compile = function(e, t) {
            var n, i = [], o = [], r = z[e + " "];
            if (!r) {
                for (t || (t = T(e)), n = t.length; n--; ) (r = g(t[n]))[I] ? i.push(r) : o.push(r);
                (r = z(e, y(o, i))).selector = e;
            }
            return r;
        }, E = t.select = function(e, t, n, i) {
            var o, r, s, a, c, u = "function" == typeof e && e, d = !i && T(e = u.selector || e);
            if (n = n || [], 1 === d.length) {
                if ((r = d[0] = d[0].slice(0)).length > 2 && "ID" === (s = r[0]).type && 9 === t.nodeType && O && C.relative[r[1].type]) {
                    if (!(t = (C.find.ID(s.matches[0].replace(ge, ye), t) || [])[0])) return n;
                    u && (t = t.parentNode), e = e.slice(r.shift().value.length);
                }
                for (o = fe.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !C.relative[a = s.type]); ) if ((c = C.find[a]) && (i = c(s.matches[0].replace(ge, ye), ve.test(r[0].type) && l(t.parentNode) || t))) {
                    if (r.splice(o, 1), !(e = i.length && f(r))) return G.apply(n, i), n;
                    break;
                }
            }
            return (u || $(e, d))(i, t, !O, n, !t || ve.test(e) && l(t.parentNode) || t), n;
        }, x.sortStable = I.split("").sort(V).join("") === I, x.detectDuplicates = !!k, 
    ...
    var Ee = /^(?:parents|prev(?:Until|All))/, De = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
    ...
    pe.fn.extend({
        ...
        pe.fn[e] = function(n, i) {
            ...
            this.length > 1 && (De[e] || pe.uniqueSort(o), Ee.test(e) && o.reverse()), this.pushStack(o);
        };
    });
    var Se = /[^\x20\t\r\n\f]+/g;
        ...
        Deferred: function(t) {
            var n = [ [ "notify", "progress", pe.Callbacks("memory"), pe.Callbacks("memory"), 2 ], [ "resolve", "done", pe.Callbacks("once memory"), pe.Callbacks("once memory"), 0, "resolved" ], [ "reject", "fail", pe.Callbacks("once memory"), pe.Callbacks("once memory"), 1, "rejected" ] ], i = "pending", o = {
                ...
                then: function(t, i, o) {
                    function r(t, n, i, o) {
                        return function() {
                            var l = this, u = arguments, f = function() {
                                var e, f;
                                if (!(t < s)) {
                                    ...
                                    f.call(e, r(s, n, a, o), r(s, n, c, o), r(s, n, a, n.notifyWith))) : (i !== a && (l = void 0, 
                                    u = [ e ]), (o || n.resolveWith)(l, u));
                                }
                            }, d = o ? f : function() {
                                try {
                                    f();
                                } catch (e) {
                                    pe.Deferred.exceptionHook && pe.Deferred.exceptionHook(e, d.stackTrace), t + 1 >= s && (i !== c && (l = void 0, 
                                    u = [ e ]), n.rejectWith(l, u));
                                }
                            };
    ...
    }), pe.ready.then = Ae.then, "complete" === te.readyState || "loading" !== te.readyState && !te.documentElement.doScroll ? e.setTimeout(pe.ready) : (te.addEventListener("DOMContentLoaded", u), 
    ...
    var Ne = function(e, t, n, i, o, r, s) {
        ...
        } else if (void 0 !== i && (o = !0, pe.isFunction(i) || (s = !0), l && (s ? (t.call(e, i), 
    ...
    f.uid = 1, f.prototype = {
        ...
        remove: function(e, t) {
            ...
            if (void 0 !== i) {
                if (void 0 !== t) {
                    n = (t = pe.isArray(t) ? t.map(pe.camelCase) : (t = pe.camelCase(t)) in i ? [ t ] : t.match(Se) || []).length;
                    for (;n--; ) delete i[t[n]];
                }
    ...
    var Oe = new f(), Le = new f(), Be = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, _e = /[A-Z]/g;
    pe.extend({
        hasData: function(e) {
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (o = Le.get(r), 1 === r.nodeType && !Oe.get(r, "hasDataAttrs"))) {
        ...
        queue: function(e, t, n) {
            var i;
            if (e) return t = (t || "fx") + "queue", i = Oe.get(e, t), n && (!i || pe.isArray(n) ? i = Oe.access(e, t, pe.makeArray(n)) : i.push(n)), 
            i || [];
        },
        ...
        promise: function(e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--; ) (n = Oe.get(r[s], e + "queueHooks")) && n.empty && (i++, 
            n.empty.add(a));
            return a(), o.promise(t);
        }
    });
    var qe = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Ie = new RegExp("^(?:([+-])=|)(" + qe + ")([a-z%]*)$", "i"), Re = [ "Top", "Right", "Bottom", "Left" ], He = function(e, t) {
    ...
    var Me = /^(?:checkbox|radio)$/i, ze = /<([a-z][^\/\0>\x20\t\r\n\f]+)/i, Ve = /^$|\/(?:java|ecma)script/i, Xe = {
    ...
    var Ue = te.documentElement, Ke = /^key/, Ge = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Je = /^([^.]*)(?:\.(.+)|)/;
    pe.event = {
        global: {},
        add: function(e, t, n, i, o) {
            var r, s, a, c, l, u, f, d, p, h, m, v = Oe.get(e);
            if (v) for (n.handler && (n = (r = n).handler, o = r.selector), o && pe.find.matchesSelector(Ue, o), 
            n.guid || (n.guid = pe.guid++), (c = v.events) || (c = v.events = {}), (s = v.handle) || (s = v.handle = function(t) {
                return void 0 !== pe && pe.event.triggered !== t.type ? pe.event.dispatch.apply(e, arguments) : void 0;
            }), l = (t = (t || "").match(Se) || [ "" ]).length; l--; ) p = m = (a = Je.exec(t[l]) || [])[1], 
            h = (a[2] || "").split(".").sort(), p && (f = pe.event.special[p] || {}, p = (o ? f.delegateType : f.bindType) || p, 
            f = pe.event.special[p] || {}, u = pe.extend({
                type: p,
                origType: m,
                data: i,
                handler: n,
        ...
        remove: function(e, t, n, i, o) {
            var r, s, a, c, l, u, f, d, p, h, m, v = Oe.hasData(e) && Oe.get(e);
            if (v && (c = v.events)) {
                for (l = (t = (t || "").match(Se) || [ "" ]).length; l--; ) if (a = Je.exec(t[l]) || [], 
                p = m = a[1], h = (a[2] || "").split(".").sort(), p) {
                    ...
                    s && !d.length && (f.teardown && !1 !== f.teardown.call(e, h, v.handle) || pe.removeEvent(e, p, v.handle), 
                    delete c[p]);
                } else for (p in c) pe.event.remove(e, p + t[l], n, i, !0);
                pe.isEmptyObject(c) && Oe.remove(e, "handle events");
            }
        },
        dispatch: function(e) {
            var t, n, i, o, r, s, a = pe.event.fix(e), c = new Array(arguments.length), l = (Oe.get(this, "events") || {})[a.type] || [], u = pe.event.special[a.type] || {};
            for (c[0] = a, t = 1; t < arguments.length; t++) c[t] = arguments[t];
            if (a.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
                for (s = pe.event.handlers.call(this, a, l), t = 0; (o = s[t++]) && !a.isPropagationStopped(); ) for (a.currentTarget = o.elem, 
        ...
        handlers: function(e, t) {
            var n, i, o, r, s, a = [], c = t.delegateCount, l = e.target;
            if (c && l.nodeType && !("click" === e.type && e.button >= 1)) for (;l !== this; l = l.parentNode || this) if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
                for (r = [], s = {}, n = 0; n < c; n++) void 0 === s[o = (i = t[n]).selector + " "] && (s[o] = i.needsContext ? pe(o, this).index(l) > -1 : pe.find(o, this, null, [ l ]).length), 
                s[o] && r.push(i);
                r.length && a.push({
                    elem: l,
                    handlers: r
    ...
    pe.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(de.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || pe.isXMLDoc(e))) for (s = g(a), 
            i = 0, o = (r = g(e)).length; i < o; i++) S(r[i], s[i]);
            if (t) if (n) for (r = r || g(e), s = s || g(a), i = 0, o = r.length; i < o; i++) D(r[i], s[i]); else D(e, a);
            return (s = g(a, "script")).length > 0 && y(s, !c && g(e, "script")), a;
        },
        cleanData: function(e) {
            for (var t, n, i, o = pe.event.special, r = 0; void 0 !== (n = e[r]); r++) if (Pe(n)) {
                if (t = n[Oe.expando]) {
        ...
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++) 1 === e.nodeType && (pe.cleanData(g(e, !1)), 
            e.textContent = "");
            return this;
        },
        clone: function(e, t) {
        ...
        html: function(e) {
            return Ne(this, function(e) {
                ...
                if ("string" == typeof e && !Ze.test(e) && !Xe[(ze.exec(e) || [ "", "" ])[1].toLowerCase()]) {
                    ...
                    try {
                        for (;n < i; n++) 1 === (t = this[n] || {}).nodeType && (pe.cleanData(g(t, !1)), 
                        t.innerHTML = e);
                        t = 0;
                    } catch (e) {}
                }
    ...
    var it = /^margin/, ot = new RegExp("^(" + qe + ")(?!px)[a-z%]+$", "i"), rt = function(t) {
    ...
    var st = /^(none|table(?!-c[ea]).+)/, at = {
        ...
        letterSpacing: "0",
        fontWeight: "400"
    }, lt = [ "Webkit", "Moz", "ms" ], ut = te.createElement("div").style;
    pe.extend({
        cssHooks: {
            opacity: {
                get: function(e, t) {
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (t = pe.cssProps[a] || (pe.cssProps[a] = O(a) || a), s = pe.cssHooks[t] || pe.cssHooks[a], 
                void 0 === n) return s && "get" in s && void 0 !== (o = s.get(e, !1, i)) ? o : c[t];
                "string" === (r = typeof n) && (o = Ie.exec(n)) && o[1] && (n = h(e, t, o), r = "number"), 
        ...
        css: function(e, t, n, i) {
            ...
            return t = pe.cssProps[a] || (pe.cssProps[a] = O(a) || a), (s = pe.cssHooks[t] || pe.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)), 
        ...
        pe.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return !st.test(pe.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? _(e, t, i) : Fe(e, at, function() {
                    return _(e, t, i);
                });
            },
            set: function(e, n, i) {
                var o, r = i && rt(e), s = i && B(e, t, i, "border-box" === pe.css(e, "boxSizing", !1, r), r);
                return s && (o = Ie.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = pe.css(e, t)), 
                L(e, n, s);
            }
        };
        ...
        }, it.test(e) || (pe.cssHooks[e + t].set = L);
    }), pe.fn.extend({
        css: function(e, t) {
    ...
    pe.Animation = pe.extend(z, {
        ...
        tweener: function(e, t) {
            ...
            for (var n, i = 0, o = e.length; i < o; i++) n = e[i], z.tweeners[n] = z.tweeners[n] || [], 
        ...
        stop: function(e, t, n) {
            ...
            this.each(function() {
                var t = !0, o = null != e && e + "queueHooks", r = pe.timers, s = Oe.get(this);
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"), this.each(function() {
                var t, n = Oe.get(this), i = n[e + "queue"], o = n[e + "queueHooks"], r = pe.timers, s = i ? i.length : 0;
        ...
        dt || (dt = e.requestAnimationFrame ? e.requestAnimationFrame(I) : e.setInterval(pe.fx.tick, pe.fx.interval));
    }, pe.fx.stop = function() {
    ...
    pe.fn.extend({
        ...
        vt[t] = function(e, t, i) {
            ...
            return i || (r = vt[s], vt[s] = o, o = null != n(e, t, i) ? s : null, vt[s] = r), 
            o;
        };
    });
    ...
    pe.fn.extend({
        ...
        addClass: function(e) {
            ...
            if ("string" == typeof e && e) for (t = e.match(Se) || []; n = this[c++]; ) if (o = X(n), 
            i = 1 === n.nodeType && " " + V(o) + " ") {
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : pe.isFunction(e) ? this.each(function(n) {
                ...
                var t, i, o, r;
                if ("string" === n) for (i = 0, o = pe(this), r = e.match(Se) || []; t = r[i++]; ) o.hasClass(t) ? o.removeClass(t) : o.addClass(t); else void 0 !== e && "boolean" !== n || ((t = X(this)) && Oe.set(this, "__className__", t), 
    ...
    pe.extend(pe.event, {
        trigger: function(t, n, i, o) {
            var r, s, a, c, l, u, f, d = [ i || te ], p = le.call(t, "type") ? t.type : t, h = le.call(t, "namespace") ? t.namespace.split(".") : [];
            ...
            f = pe.event.special[p] || {}, o || !f.trigger || !1 !== f.trigger.apply(i, n))) {
                ...
                (u = (Oe.get(s, "events") || {})[t.type] && Oe.get(s, "handle")) && u.apply(s, n), 
                (u = l && s[l]) && u.apply && Pe(s) && (t.result = u.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = p, o || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(d.pop(), n) || !Pe(i) || l && pe.isFunction(i[p]) && !pe.isWindow(i) && ((a = i[l]) && (i[l] = null), 
                pe.event.triggered = p, i[p](), pe.event.triggered = void 0, a && (i[l] = a)), t.result;
            }
        },
    ...
    var Tt = /\[\]$/, $t = /\r?\n/g, Et = /^(?:submit|button|image|reset|file)$/i, Dt = /^(?:input|select|textarea|keygen)/i;
    pe.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !pe(this).is(":disabled") && Dt.test(this.nodeName) && !Et.test(e) && (this.checked || !Me.test(e));
            }).map(function(e, t) {
                var n = pe(this).val();
    ...
    var St = /%20/g, kt = /#.*$/, At = /([?&])_=[^&]*/, Nt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Pt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ot = /^(?:GET|HEAD)$/, Lt = /^\/\//, Bt = {}, _t = {}, qt = "*/".concat("*"), It = te.createElement("a");
    It.href = Ct.href, pe.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function(t, n) {
            function i(t, n, i, a) {
                var l, d, p, x, C, w = n;
                u || (u = !0, c && e.clearTimeout(c), o = void 0, s = a || "", j.readyState = t > 0 ? 4 : 0, 
                l = t >= 200 && t < 300 || 304 === t, i && (x = J(h, j, i)), x = Q(h, x, j, l), 
                l ? (h.ifModified && ((C = j.getResponseHeader("Last-Modified")) && (pe.lastModified[r] = C), 
                (C = j.getResponseHeader("etag")) && (pe.etag[r] = C)), 204 === t || "HEAD" === h.type ? w = "nocontent" : 304 === t ? w = "notmodified" : (w = x.state, 
                d = x.data, l = !(p = x.error))) : (p = w, !t && w || (w = "error", t < 0 && (t = 0))), 
                j.status = t, j.statusText = (n || w) + "", l ? g.resolveWith(m, [ d, w, j ]) : g.rejectWith(m, [ j, w, p ]), 
                j.statusCode(b), b = void 0, f && v.trigger(l ? "ajaxSuccess" : "ajaxError", [ j, h, l ? d : p ]), 
                y.fireWith(m, [ j, w ]), f && (v.trigger("ajaxComplete", [ j, h ]), --pe.active || pe.event.trigger("ajaxStop")));
            }
            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var o, r, s, a, c, l, u, f, d, p, h = pe.ajaxSetup({}, n), m = h.context || h, v = h.context && (m.nodeType || m.jquery) ? pe(m) : pe.event, g = pe.Deferred(), y = pe.Callbacks("once memory"), b = h.statusCode || {}, x = {}, C = {}, w = "canceled", j = {
                readyState: 0,
                ...
                setRequestHeader: function(e, t) {
                    return null == u && (e = C[e.toLowerCase()] = C[e.toLowerCase()] || e, x[e] = t), 
                    this;
                },
                ...
                statusCode: function(e) {
                    var t;
                    if (e) if (u) j.always(e[j.status]); else for (t in e) b[t] = [ b[t], e[t] ];
                    return this;
                },
                abort: function(e) {
                    var t = e || w;
            ...
            if (g.promise(j), h.url = ((t || h.url || Ct.href) + "").replace(Lt, Ct.protocol + "//"), 
            ...
            K(Bt, h, n, j), u) return j;
            (f = pe.event && h.global) && 0 == pe.active++ && pe.event.trigger("ajaxStart"), 
            h.type = h.type.toUpperCase(), h.hasContent = !Ot.test(h.type), r = h.url.replace(kt, ""), 
            h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(St, "+")) : (p = h.url.slice(r.length), 
            h.data && (r += (jt.test(r) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (r = r.replace(At, "$1"), 
            ...
            if (w = "abort", y.add(h.complete), j.done(h.success), j.fail(h.error), o = K(_t, h, n, j)) {
                if (j.readyState = 1, f && v.trigger("ajaxSend", [ j, h ]), u) return j;
    ...
    de.cors = !!Ht && "withCredentials" in Ht, de.ajax = Ht = !!Ht, pe.ajaxTransport(function(t) {
        var n, i;
    ...
    pe.ajaxSetup({
        ...
        a ? t[a] = t[a].replace(Wt, "$1" + o) : !1 !== t.jsonp && (t.url += (jt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), 
        t.converters["script json"] = function() {
            ...
            Ft.push(o)), s && pe.isFunction(r) && r(s[0]), s = r = void 0;
        }), "script";
        ...
        return a > -1 && (i = V(e.slice(a)), e = e.slice(0, a)), pe.isFunction(t) ? (n = t, 
        ...
        setOffset: function(e, t, n) {
            var i, o, r, s, a, c, l = pe.css(e, "position"), u = pe(e), f = {};
            "static" === l && (e.style.position = "relative"), a = u.offset(), r = pe.css(e, "top"), 
            c = pe.css(e, "left"), ("absolute" === l || "fixed" === l) && (r + c).indexOf("auto") > -1 ? (s = (i = u.position()).top, 
    ...
    return pe.noConflict = function(t) {
        return e.$ === pe && (e.$ = zt), t && e.jQuery === pe && (e.jQuery = Mt), pe;
    }, t || (e.jQuery = e.$ = pe), pe;
...
!function(e, t) {
    e.fn.confirm = function(t, n) {
        ...
        setStartingPoint: function() {
            ...
            var s = i.top + o;
            s -= this._scrollTop();
            var a = i.left + r, c = e(t).height() / 2, l = e(t).width() / 2;
            if (s -= c - this.$jconfirmBox.outerHeight() / 2, a -= l - this.$jconfirmBox.outerWidth() / 2, 
            Math.abs(s) > c || Math.abs(a) > l) return !1;
        ...
        $.confirm({
            ...
            buttons: {
                aceptar: {
                    text: "Okay",
                    action: function() {
                        0 == t && $(location).attr("href", "promocion.php"), 1 == t && $(location).attr("href", "evento.php");
                    }
                }
            }
        });
    ...
    function ValidarEvento() {
        var e = 0, t = !0;
        return $("#EventoInsertar #categorias option:selected").each(function() {
            e++;
        }), parseInt($("#EventoInsertar #PrecioInferior").val()) > parseInt($("#EventoInsertar #PrecioSuperior").val()) && ($.alert({
    ...
    function ValidarRegistroEstablecimiento() {
        var e = !0, t = (document.RegistroEstablecimiento.NombreEstablecimiento.value, document.RegistroEstablecimiento.Descripcion.value, 
        document.RegistroEstablecimiento.Usuario.value), n = document.RegistroEstablecimiento.ApellidoMaterno.value, i = document.RegistroEstablecimiento.ApellidoPaterno.value, o = (document.RegistroEstablecimiento.Username.value, 
        document.RegistroEstablecimiento.CorreoElectronico.value), r = document.RegistroEstablecimiento.Contrasena.value, s = document.RegistroEstablecimiento.ConfirmarContrasena.value;
        return 0 == (e = ValidarTextComun(t, "usuario")) ? e : 0 == (e = ValidarTextComun(i, "apellido paterno")) ? e : "" != n && 0 == (e = ValidarTextComun(n, "apellido materno")) ? e : 0 == (e = ValidarCorreo(o)) ? e : 0 == (e = ValidarContrasena(r)) ? e : (e = ContrasenasIguales(r, s), 
        0 == e ? e : void 0);
    }
    function ValidarRegistroCliente() {
        var e = !0, t = document.RegistroCliente.Cliente.value, n = document.RegistroCliente.ApellidoMaterno.value, i = document.RegistroCliente.ApellidoPaterno.value, o = (document.RegistroCliente.Username.value, 
        document.RegistroCliente.CorreoElectronico.value), r = document.RegistroCliente.Contrasena.value, s = document.RegistroCliente.ConfirmarContrasena.value;
        return 0 == (e = ValidarTextComun(t, "usuario")) ? e : 0 == (e = ValidarTextComun(i, "apellido paterno")) ? e : "" != n && 0 == (e = ValidarTextComun(n, "apellido materno")) ? e : 0 == (e = ValidarCorreo(o)) ? e : 0 == (e = ValidarContrasena(r)) ? e : (e = ContrasenasIguales(r, s), 
        0 == e ? e : void 0);
    }
    function ValidarTextComun(e, t) {
        var n = /^[a-zA-Z\sÑñáéíóúüÁÉÍÓÚ]*$/;
        if (e.search(n)) {
            var i = "El campo " + t + " sólo permite letras";
            return $.alert({
    ...
    function ValidarSoloNumeros(e, t) {
        var n = /^[0-9]+([,][0-9]+)?$/;
        if (e.search(n)) {
            var i = "El campo " + t + " sólo acepta números";
            return $.alert({
                title: "Caracteres inválidos",
                content: i,
                boxWidth: "30%",
    ...
    function ValidarCorreo(e) {
        var t = /^[-\w.%+]{1,64}@(?:[A-Z0-9-]{1,63}\.){1,125}[A-Z]{2,63}$/i;
        if (e.search(t)) return $.alert({
            title: "Caracteres inválidos",
    ...
    function ValidarContrasena(e) {
        ...
        if (e.search(t)) {
            return $.alert({
                title: "Caracteres inválidos",
                content: "Su contraseña no coincide con alguno de los requisitos: <br><br>Una mayúscula <br>Una minúscula <br>Una letra <br>Por lo menos 8 caracteres <br>Sin espacios en blanco",
                boxWidth: "30%",
                useBootstrap: !1
            }), !1;
        }
    }
    function ContrasenasIguales(e, t) {
        if (e != t) return $.alert({
            title: "Caracteres inválidos",
    ...
    function NuevoHorario() {
        ...
        for (var t = document.getElementsByName("diasSemana"), n = 0; n < 7; n++) t[n].checked && (e[n] = n + 1, 
        window.alert(e[n]));
    }
    function VerificarHorario(e, t) {
        if (e >= t) return window.alert("La hora de inicio no puede ser mayor a la hora de termino"), 
        !1;
    }
    $("#IniciarSesion").submit(function(event) {
        var correo = document.IniciarSesion.Vcorreo.value, clave = document.IniciarSesion.Vpass.value, formData = new FormData(document.getElementById("IniciarSesion"));
        return $.ajax({
            async: !1,
            type: "POST",
            ...
            success: function(data) {
                var valores = eval(data), mensaje = valores[0];
                estado = valores[1], estado ? 2 == mensaje ? $(location).attr("href", "topEvento.php") : 1 == mensaje && $(location).attr("href", "evento.php") : $.alert({
                    closeAnimation: "rotate",
                    title: "¡Oh, no!",
                    content: mensaje,
                    boxWidth: "30%",
        ...
        if (res) {
            valores = new Array();
            var cont = 0, dias = "";
            if ($("#tabla tbody tr").each(function() {
                var e = $(this).find("td").eq(0).html(), t = $(this).find("td").eq(2).html(), n = $(this).find("td").eq(3).html();
                e = (e = "#time") + cont + " option", $(e).each(function() {
                    dias += $(this).attr("value") + ",";
                }), cont++, valor = new Array(e, t, n, dias), dias = "", 0 != cont && valores.push(valor);
            }), 0 != cont) {
                var formData = new FormData(document.getElementById("EventoInsertar"));
                formData.append("valores", JSON.stringify(valores)), $.ajax({
                    async: !1,
                    type: "POST",
                    ...
                    processData: !1,
                    success: function(data) {
                        var valores = eval(data), mensaje = valores[0], estado = valores[1];
                        estado ? $(location).attr("href", "evento.php") : $.alert({
                            closeAnimation: "rotate",
                            title: "¡Oh, no!",
                            content: mensaje,
                            boxWidth: "30%",
        ...
        var evento = $(this).children().val(), mensaje = "", estado = !1;
        return $.confirm({
                    ...
                    action: function() {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                mensaje = valores[0], estado = valores[1], deletePE(mensaje, 1);
                            },
                            error: function(e) {
                                estado = !1, deletePE(mensaje = "Ocurrió algo mientras se enviaban los datos.", 1);
                            }
                        });
                    }
                }
        ...
        event.preventDefault(), valores = new Array();
        var cont = 0, dias = "";
        if ($("#tabla tbody tr").each(function() {
            var e = $(this).find("td").eq(0).html(), t = $(this).find("td").eq(2).html(), n = $(this).find("td").eq(3).html();
            e = (e = "#timep") + cont + " option", $(e).each(function() {
                dias += $(this).attr("value") + ",";
            }), cont++, valor = new Array(e, t, n, dias), dias = "", 0 != cont && valores.push(valor);
        }), cont > 0) {
            ...
            formData.append("valores", JSON.stringify(valores)), $.ajax({
                ...
                success: function(data) {
                    var valores = eval(data), mensaje = valores[0], estado = valores[1];
                    estado ? $(location).attr("href", "promocion.php") : $.alert({
                        closeAnimation: "rotate",
                        title: "¡Oh, no!",
                        content: mensaje,
                        boxWidth: "30%",
        ...
        return formData.append("valores", JSON.stringify(valores)), $.ajax({
            async: !1,
            type: "POST",
            ...
            success: function(data) {
                ...
                $.alert({
                    ...
                    boxWidth: "30%",
                    useBootstrap: !1
                }), estado && $(location).attr("href", "promocion.php");
            },
            error: function(e) {
                $.alert({
                    title: "¡Oh, no!",
        ...
        var promocion = $(this).children().val(), mensaje = "", estado = !1;
        return $.confirm({
                ...
                aceptar: {
                    ...
                    action: function() {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                var valores = eval(data);
                                mensaje = valores[0], estado = valores[1], deletePE(mensaje, 0);
                            },
                            error: function(e) {
                                estado = !1, deletePE(mensaje = "Ocurrió algo mientras se enviaban los datos.", 0);
                            }
                        });
                    }
                }
    ...
    }), $("#RegistroEstablecimiento").submit(function(event) {
        ...
        if (0 != res) {
            ...
            var cont = 0, dias = "";
            if ($("#tabla tbody tr").each(function() {
                var e = $(this).find("td").eq(0).html(), t = $(this).find("td").eq(2).html(), n = $(this).find("td").eq(3).html(), i = "#dias" + cont + " option";
                $(i).each(function() {
                    dias += $(this).attr("value") + ",";
                }), cont++, "" != dias && (valor = new Array(e, t, n, dias)), dias = "", valores.push(valor);
            }), cont > 0) {
                ...
                formData.append("valores", JSON.stringify(valores)), $.ajax({
                    ...
                    success: function(data) {
                        var valores = eval(data), mensaje = valores[0], estado = valores[1];
                        estado ? $(location).attr("href", "cuentaEstablecimiento.php") : $.alert({
                            closeAnimation: "rotate",
                            title: "¡Oh, no!",
                            content: mensaje,
                            boxWidth: "30%",
        ...
        if (0 != res) {
            ...
            if ($.ajax({
                ...
                var correo = document.RegistroCliente.CorreoElectronico.value, clave = document.RegistroCliente.Contrasena.value, datos = {
                    Vcorreo: correo,
                    Vpass: clave
                };
                $.ajax({
                    ...
                    success: function(data) {
                        var valores = eval(data), mensaje = valores[0], estado = valores[1];
                        estado ? 2 == mensaje ? $(location).attr("href", "topEvento.php") : 1 == mensaje && $(location).attr("href", "evento.php") : (alert(mensaje), 
        ...
        texto(this.value) && (this.value = this.value.replace(/[^ a-záéíóúüñ]+/gi, ""));
