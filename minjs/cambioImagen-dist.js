!function(e, t) {
    ...
    function h(e, t, n, r) {
        var i, o = 1, a = 20, s = r ? function() {
            ...
            return de.css(e, t, "");
        }, u = s(), l = n && n[3] || (de.cssNumber[t] ? "" : "px"), c = (de.cssNumber[t] || "px" !== l && +u) && Ie.exec(de.css(e, t));
        if (c && c[3] !== l) {
            l = l || c[3], n = n || [], c = +u || 1;
            do {
    ...
    function I() {
        pt && (e.requestAnimationFrame(I), de.fx.tick());
    }
    function M() {
    ...
    function B(e, t, n) {
        var r, i, o, a, s, u, l, c, f = "width" in t || "height" in t, p = this, d = {}, h = e.style, g = e.nodeType && $e(e), v = He.get(e, "fxshow");
        ...
        if ((u = !de.isEmptyObject(t)) || !de.isEmptyObject(d)) {
            ...
            })), u = W(g ? v[r] : 0, r, p), r in v || (v[r] = u.start, g && (u.end = u.start, 
            u.start = 0));
        }
    }
    function _(e, t) {
    ...
    var ye = function(e) {
        ...
        function y(e, n) {
            var i = n.length > 0, o = e.length > 0, a = function(r, a, s, u, l) {
                var c, f, p, d = 0, h = "0", m = r && [], v = [], y = S, x = r || o && w.find.TAG("*", l), b = $ += null == y ? 1 : Math.random() || .1, T = x.length;
        ...
        var x, b, w, T, C, E, k, N, S, D, j, A, q, L, H, F, O, P, R, I = "sizzle" + 1 * new Date(), M = e.document, $ = 0, W = 0, B = n(), _ = n(), z = n(), X = function(e, t) {
            return e === t && (j = !0), 0;
        ...
        b = t.support = {}, C = t.isXML = function(e) {
            ...
            b.attributes = i(function(e) {
                ...
                e.querySelectorAll("[id~=" + I + "-]").length || F.push("~="), e.querySelectorAll(":checked").length || F.push(":checked"), 
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [ a ? m.firstChild : m.lastChild ], a && y) {
                                for (x = (d = (l = (c = (f = (p = m)[I] || (p[I] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === $ && l[1]) && l[2], 
                                p = d && m.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || h.pop(); ) if (1 === p.nodeType && ++x && p === t) {
                                    c[e] = [ $, d, x ];
                                    break;
                                }
                            } else if (y && (x = d = (l = (c = (f = (p = t)[I] || (p[I] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === $ && l[1]), 
                            !1 === x) for (;(p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++x || (y && ((c = (f = p[I] || (p[I] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [ $, x ]), 
                            p !== t)); ) ;
        ...
        return c.prototype = w.filters = w.pseudos, w.setFilters = new c(), E = t.tokenize = function(e, n) {
            ...
            var n, r = [], i = [], o = z[e + " "];
            if (!o) {
                for (t || (t = E(e)), n = t.length; n--; ) (o = v(t[n]))[I] ? r.push(o) : i.push(o);
        ...
        }, b.sortStable = I.split("").sort(X).join("") === I, b.detectDuplicates = !!j, 
    ...
    var Re = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Ie = new RegExp("^(?:([+-])=|)(" + Re + ")([a-z%]*)$", "i"), Me = [ "Top", "Right", "Bottom", "Left" ], $e = function(e, t) {
    ...
    de.fn.extend({
        ...
        toggle: function(e) {
            return "boolean" == typeof e ? e ? this.show() : this.hide() : this.each(function() {
                $e(this) ? de(this).show() : de(this).hide();
            });
        }
    });
    ...
    de.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" === (o = typeof n) && (i = Ie.exec(n)) && i[1] && (n = h(e, t, i), o = "number"), 
        ...
        de.cssHooks[t] = {
            ...
            set: function(e, n, r) {
                ...
                return a && (i = Ie.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = de.css(e, t)), 
                F(e, n, a);
            }
        };
    ...
    var Dt = /%20/g, jt = /#.*$/, At = /([?&])_=[^&]*/, qt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Lt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ht = /^(?:GET|HEAD)$/, Ft = /^\/\//, Ot = {}, Pt = {}, Rt = "*/".concat("*"), It = te.createElement("a");
    It.href = wt.href, de.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
    ...
    function e(e) {
        var n = e.target.files[0], r = /image.*/;
        if (n.type.match(r)) {
            var i = new FileReader();
            i.onload = t, i.readAsDataURL(n);
        }
    }
    function t(e) {
        var t = e.target.result, n = $(".prevImage").width() / 15 * 7;
        $(".showImg").css({
            height: n + "px"
        }), $(".showImg").css({
            width: n + "px"
        }), $("#salidaImagen").attr("src", t);
    }
    !function(e, t, n, r) {
        e(".inputfile").each(function() {
            var t = e(this), n = t.next("label");
            t.on("change", function(e) {
                var t = "";
                e.target.value && (t = e.target.value.split("\\").pop()), t && n.find("span").html(t);
            });
        });
    }(jQuery, window, document), $("#fileinputI").change(function(t) {
        e(t);
    });
});